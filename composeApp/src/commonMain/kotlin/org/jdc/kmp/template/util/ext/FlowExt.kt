package org.jdc.kmp.template.util.ext
 ...
 */
inline fun <T, R> Flow<T>.mapDistinct(crossinline transform: suspend (value: T) -> R) = this.map(transform).distinctUntilChanged()